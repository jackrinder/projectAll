...
# instantiates a new user object with its attributes initialized
...
# checks if the 
  ...
  describe "micropost associations" do
    ...
    it "should have the right microposts in the right order" do
      # user.microposts is an array of microposts
  ...
  describe "return value of authenticate method" do
    ...
    describe "with valid password" do
      ...
      #found_user.authenticate(@user.password) returns the @user object 
      #which is exactly with what we compare it (it)
    ...
    describe "with invalid password" do
      ...
      # it refers to the @user
      # found_user.authenticate("invalid") returns not the user object
      #but instead the boolean false which is not the user object
